...
class ExampleSpider(BaseSpider[AiohttpClient, dict]):
    BASE_TAG = "book"  # Базовый тэг, данные полученные отсюда сразу будут отмечены как images
    BASE_URL = (
        "https://books.toscrape.com"  # Базовый URL, необходим для пагинации, urljoin и т п.
    )
